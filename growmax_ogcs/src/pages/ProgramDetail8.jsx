...
import styles from '../styles/ProgramDetail8.module.css';
import { baseurl } from '../api'

const ProgramDetail8 = () => {
  const location = useLocation();
  const program8 = location.state?.program || {}; // Safely access program data
  ...
  return (
    <div className={styles.pageContainer}>
      <div className={styles.card}>
        {/* Program Title */}
        <h1 className={styles.title}>{program8.name}</h1>
        ...
        <div className={styles.section}>
          ...
          <p className={styles.text}>{program8.description}</p>
        </div>
      ...
      {showModal && (
        <div className={styles.modalOverlay}>
          <div className={styles.modal}>
            <h2 className={styles.modalTitle}>Join {program8.name}</h2>
