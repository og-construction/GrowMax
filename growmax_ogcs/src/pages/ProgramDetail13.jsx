...
import styles from '../styles/ProgramDetail13.module.css';
import { baseurl } from '../api'

const ProgramDetail13 = () => {
  const location = useLocation();
  const program13 = location.state?.program || {}; // Safely access program data
  ...
  return (
    <div className={styles.pageContainer}>
      <div className={styles.card}>
        {/* Program Title */}
        <h1 className={styles.title}>{program13.name}</h1>
        ...
        <div className={styles.section}>
          ...
          <p className={styles.text}>{program13.description}</p>
        </div>
      ...
      {showModal && (
        <div className={styles.modalOverlay}>
          <div className={styles.modal}>
            <h2 className={styles.modalTitle}>Join {program13.name}</h2>
...
export default ProgramDetail13;
