...
import styles from '../styles/ProgramDetail7.module.css';
import { baseurl } from '../api'


const ProgramDetail7 = () => {
  const location = useLocation();
  const program7 = location.state?.program || {}; // Safely access program data
  ...
  return (
    <div className={styles.pageContainer}>
      <div className={styles.card}>
        {/* Program Title */}
        <h1 className={styles.title}>{program7.name}</h1>
        ...
        <div className={styles.section}>
          ...
          <p className={styles.text}>{program7.description}</p>
        </div>
      ...
      {showModal && (
        <div className={styles.modalOverlay}>
          <div className={styles.modal}>
            <h2 className={styles.modalTitle}>Join {program7.name}</h2>
