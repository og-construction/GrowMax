...
import styles from '../styles/ProgramDetail23.module.css';
import { baseurl } from '../api'

const ProgramDetail23 = () => {
  const location = useLocation();
  const program23 = location.state?.program || {}; // Safely access program data
  ...
  return (
    <div className={styles.pageContainer}>
      <div className={styles.card}>
        <h1 className={styles.title}>{program23.name}</h1>
        <img src={program23.image} alt={program23.name} className={styles.image} />

        <div className={styles.section}>
          <h2 className={styles.sectionTitle}>About the Program</h2>
          <p className={styles.text}>{program23.description}</p>
        </div>
      ...
      {showModal && (
        <div className={styles.modalOverlay}>
          <div className={styles.modal}>
            <h2 className={styles.modalTitle}>Join {program23.name}</h2>
...
export default ProgramDetail23;
