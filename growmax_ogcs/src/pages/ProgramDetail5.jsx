...
import styles from '../styles/ProgramDetail5.module.css';
import { baseurl } from '../api'

const ProgramDetail5 = () => {
  const location = useLocation();
  const program5 = location.state?.program || {}; // Safely access program data
  ...
  return (
    <div className={styles.pageContainer}>
      <div className={styles.card}>
        {/* Program Title */}
        <h1 className={styles.title}>{program5.name}</h1>
        ...
        <div className={styles.section}>
          ...
          <p className={styles.text}>{program5.description}</p>
        </div>
      ...
      {showModal && (
        <div className={styles.modalOverlay}>
          <div className={styles.modal}>
            <h2 className={styles.modalTitle}>Join {program5.name}</h2>
