...
import styles from '../styles/ProgramDetail16.module.css';
import { baseurl } from '../api'

const ProgramDetail16 = () => {
  const location = useLocation();
  const program16 = location.state?.program || {}; // Safely access program data
  ...
  return (
    <div className={styles.pageContainer}>
      <div className={styles.card}>
        {/* Program Title */}
        <h1 className={styles.title}>{program16.name}</h1>
        ...
        <div className={styles.section}>
          ...
          <p className={styles.text}>{program16.description}</p>
        </div>
      ...
      {showModal && (
        <div className={styles.modalOverlay}>
          <div className={styles.modal}>
            <h2 className={styles.modalTitle}>Join {program16.name}</h2>
...
export default ProgramDetail16;
