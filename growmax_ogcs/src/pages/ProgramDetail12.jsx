...
import styles from '../styles/ProgramDetail12.module.css';
import { baseurl } from '../api'

const ProgramDetail12 = () => {
  const location = useLocation();
  const program12 = location.state?.program || {}; // Safely access program data
  ...
  return (
    <div className={styles.pageContainer}>
      <div className={styles.card}>
        {/* Program Title */}
        <h1 className={styles.title}>{program12.name}</h1>
        ...
        <div className={styles.section}>
          ...
          <p className={styles.text}>{program12.description}</p>
        </div>
      ...
      {showModal && (
        <div className={styles.modalOverlay}>
          <div className={styles.modal}>
            <h2 className={styles.modalTitle}>Join {program12.name}</h2>
...
export default ProgramDetail12;
