...
const ProgramDetail18 = () => {
  ...
  const program18 = location.state?.program || {}; // Safely access program data
  ...
  return (
    <div className={styles.pageContainer}>
      <div className={styles.card}>
        {/* Program Title */}
        <h1 className={styles.title}>{program18.name}</h1>
        ...
        <div className={styles.section}>
          ...
          <p className={styles.text}>{program18.description}</p>
        </div>
      ...
      {showModal && (
        <div className={styles.modalOverlay}>
          <div className={styles.modal}>
            <h2 className={styles.modalTitle}>Join {program18.name}</h2>
...
export default ProgramDetail18;
