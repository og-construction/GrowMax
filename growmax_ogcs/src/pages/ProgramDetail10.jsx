...
import styles from '../styles/ProgramDetail10.module.css';
import { baseurl } from '../api'

const ProgramDetail10 = () => {
  const location = useLocation();
  const program10 = location.state?.program || {}; // Safely access program data
  ...
  return (
    <div className={styles.pageContainer}>
      <div className={styles.card}>
        {/* Program Title */}
        <h1 className={styles.title}>{program10.name}</h1>
        ...
        <div className={styles.section}>
          ...
          <p className={styles.text}>{program10.description}</p>
        </div>
      ...
      {showModal && (
        <div className={styles.modalOverlay}>
          <div className={styles.modal}>
            <h2 className={styles.modalTitle}>Join {program10.name}</h2>
...
export default ProgramDetail10;
