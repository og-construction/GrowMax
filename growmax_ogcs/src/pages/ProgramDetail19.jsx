...
import styles from '../styles/ProgramDetail19.module.css';
import { baseurl } from '../api'

const ProgramDetail19 = () => {
  const location = useLocation();
  const program19 = location.state?.program || {}; // Safely access program data
  ...
  return (
    <div className={styles.pageContainer}>
      <div className={styles.card}>
        {/* Program Title */}
        <h1 className={styles.title}>{program19.name}</h1>
        ...
        <div className={styles.section}>
          ...
          <p className={styles.text}>{program19.description}</p>
        </div>
      ...
      {showModal && (
        <div className={styles.modalOverlay}>
          <div className={styles.modal}>
            <h2 className={styles.modalTitle}>Join {program19.name}</h2>
...
export default ProgramDetail19;
