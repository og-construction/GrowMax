...
import styles from '../styles/ProgramDetail4.module.css';

const ProgramDetail4 = () => {
  const location = useLocation();
  const program4 = location.state?.program || {}; // Safely access program data
  ...
  return (
    <div className={styles.pageContainer}>
      <div className={styles.card}>
        {/* Program Title */}
        <h1 className={styles.title}>{program4.name}</h1>
        ...
        <div className={styles.section}>
          ...
          <p className={styles.text}>{program4.description}</p>
        </div>
      ...
      {showModal && (
        <div className={styles.modalOverlay}>
          <div className={styles.modal}>
            <h2 className={styles.modalTitle}>Join {program4.name}</h2>
