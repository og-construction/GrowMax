...
import styles from '../styles/ProgramDetail9.module.css';
import { baseurl } from '../api'

const ProgramDetail9 = () => {
  const location = useLocation();
  const program9 = location.state?.program || {}; // Safely access program data
  ...
  return (
    <div className={styles.pageContainer}>
      <div className={styles.card}>
        {/* Program Title */}
        <h1 className={styles.title}>{program9.name}</h1>
        ...
        <div className={styles.section}>
          ...
          <p className={styles.text}>{program9.description}</p>
        </div>
      ...
      {showModal && (
        <div className={styles.modalOverlay}>
          <div className={styles.modal}>
            <h2 className={styles.modalTitle}>Join {program9.name}</h2>
