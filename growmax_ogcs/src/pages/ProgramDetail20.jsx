...
import styles from '../styles/ProgramDetail20.module.css';
import { baseurl } from '../api'

const ProgramDetail20 = () => {
  const location = useLocation();
  const program20 = location.state?.program || {}; // Safely access program data
  ...
  return (
    <div className={styles.pageContainer}>
      <div className={styles.card}>
        {/* Program Title */}
        <h1 className={styles.title}>{program20.name}</h1>
        ...
        <div className={styles.section}>
          ...
          <p className={styles.text}>{program20.description}</p>
        </div>
      ...
      {showModal && (
        <div className={styles.modalOverlay}>
          <div className={styles.modal}>
            <h2 className={styles.modalTitle}>Join {program20.name}</h2>
...
export default ProgramDetail20;
